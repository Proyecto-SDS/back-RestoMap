...
from models.models import Favorito, Local, Usuario
...
@requerir_auth
def get_favoritos(user_id, user_rol):
    """
            ...
            'favoritos': [
                {
                    ...
                    'agregadoEl': fav.agregado_el.isoformat() if fav.agregado_el else None
                }
...
@requerir_auth
def add_favorito(user_id, user_rol):
    """
    ...
    try:
        ...
        return jsonify({
            ...
            'favorito': {
                ...
                'agregadoEl': nuevo_favorito.agregado_el.isoformat() if nuevo_favorito.agregado_el else None
            }
        }), 201
        
    except Exception as e:
        logger.error(f"Error en add_favorito: {str(e)}")
        return jsonify({'error': 'Error al agregar favorito'}), 500


@favoritos_bp.route('/<int:local_id>', methods=['DELETE'])
@requerir_auth
def remove_favorito(user_id, user_rol, local_id):
    """
